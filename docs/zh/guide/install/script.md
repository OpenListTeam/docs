...
**安装**
```bash
curl -fsSL "https://openlist.example.com/v3.sh" -o v3.sh && bash v3.sh
```
...
```bash
# Install
curl -fsSL "https://openlist.example.com/v3.sh" -o v3.sh && bash v3.sh install /root
# update
curl -fsSL "https://openlist.example.com/v3.sh" -o v3.sh && bash v3.sh update /root
# Uninstall
curl -fsSL "https://openlist.example.com/v3.sh" -o v3.sh && bash v3.sh uninstall /root
```
