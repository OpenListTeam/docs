...
Get the tool https://alist.example.com/tool/google/request
...
According to [above](https://alist.example.com/tool/google/request) obtained **client ID** and **secret key** and **refresh_token**

We fill in **https://alist.example.com/tool/google/album** to get a single catalog ID for each of our Google Photos
