...
<img src="/img/drivers/4.png" alt="alt text" width="50%">

3. After entering, select SMS login. Once logged in, return to the storage management page, disable and re-enable the storage, and it should work normally (you may need to refresh the page).

<img src="/img/drivers/3.png" alt
